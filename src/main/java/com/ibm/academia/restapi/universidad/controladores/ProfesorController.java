...
public class ProfesorController {
	...
	public ResponseEntity<?> eliminarProfesor(@PathVariable Long profesorId){
		...
		return new ResponseEntity<String>("El profesor con id: "+ profesorId +" se eliminó satisfactoriamente.", HttpStatus.NO_CONTENT);
	...
	public ResponseEntity<?> actualizarProfesor(@PathVariable Long profesorId, @RequestBody Persona profesor){
		...
		Persona profesorActualizado = ((ProfesorDAO)profesorDao).actualizarProfesor(profesorId, profesor);
